  ...
  try {
    ...
    const kpis: DashboardMetrics["kpis"] = {
      ...
      entradasHoje: {
        ...
        tooltip: `${entradasList.length} pagamento(s) recebido(s) no periodo (por data de pagamento)`,
        color: "success",
      },
      comissaoReal: {
        label: "Comissao Real",
        ...
        tooltip: "Comissao das vendas pagas",
        color: "success",
      },
      comissaoProjetada: {
        ...
        tooltip: "Comissao esperada (agendadas + aguardando)",
        color: "brand",
      },
      valorReceber: {
        label: "A Receber",
      ...
      investimento: {
        ...
        tooltip: `Meta ${formatCurrency(metaSpendTotal)} + manual ${formatCurrency(manualSpend)} (${investmentEntriesCount} lancamento${investmentEntriesCount !== 1 ? "s" : ""}) + ${adsTaxPercent}% imposto`,
        color: "warning",
      },
      roi: {
        label: "ROI",
      ...
      cac: {
        ...
        tooltip: "Custo de aquisicao por cliente (vendas pagas)",
        color: "neutral",
      },
      lucro: {
        label: "Lucro",
      ...
      cpa: {
        ...
        tooltip: `Custo por aquisicao: ${formatCurrency(investimentoComImposto)} / ${quantidadeBase} pedidos`,
        color: "neutral",
      },
      caixaEsperado: {
